    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Kelola CV Anggota</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 200px;">Nama Anggota</th>
                                            <th>CV Filename</th>
                                            <th>Status</th>
                                            <th>Tgl Masuk</th>
                                   ...
                                   @foreach($data as $key) 
                                        ...
                                        <form method="post" action="/del_dok/{{ $key->id}}">  
                                        {{ method_field('DELETE') }}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel">Edit CV Anggota</h4>
            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3" style="margin-top:7px;">
                                <label for="firstname">Status Dokumen </label>
                            </div>
                            <div class="col-md-8">
                                <select name="status_cv" class="form-control">
                                   <option>--Pilih Status Dokumen--</option>
                                   <option value="Accept">1.Accept</option>
